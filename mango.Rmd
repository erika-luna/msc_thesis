...
write.csv(mango_lm, file = "mango_lm.csv")
```
...
mango_irrigated_yields_ts <- ts(mango_irrigated_yields, start = 1980)
mango_rainfed_yields_ts <- ts(mango_rainfed_yields, start = 1980)

#Obtain trend
mango_irrigated_yields_trend <- ma(mango_irrigated_yields_ts, order = 4, centre = T )
mango_rainfed_yields_trend <- ma(mango_rainfed_yields_ts, order = 4, centre = T )

#Remove trend by applying log to ts and trend
mango_irrigated_detrend <- log(mango_irrigated_yields_ts) - log(mango_irrigated_yields_trend)
mango_rainfed_detrend <- log(mango_rainfed_yields_ts) - log(mango_rainfed_yields_trend)
